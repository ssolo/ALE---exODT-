...
int main(int argc, char ** argv)
{
  ...
  approx_posterior * sample_trees_ale=obsorve_ALE_from_strings(sample_strings);  
  Tree* ccp_tree=TreeTemplateTools::parenthesisToTree(sample_trees_ale->mpp_tree().first);
  TreeTools::computeBootstrapValues(*ccp_tree,sample_trees);
  string ccp_tree_sup=TreeTemplateTools::treeToParenthesis(*ccp_tree);
  cout << "#ccp tree: " << ccp_tree_sup;
